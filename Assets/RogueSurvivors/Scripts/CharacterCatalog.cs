...
namespace RogueSurvivors
{
    ...
    public static class CharacterCatalog
    {
        public static readonly CharacterDefinition[] All = {
            ...
            new CharacterDefinition("mage", "メイジ", "初期属性を9種類から選択\n選択武器 Lv2／攻撃力＋10%\n属性武器が出やすい", new Color(1, .55f, .25f)),
        ...
        public static PlayerDataData CreateBuild(string id, string mageWeapon = "fireball")
        {
            ...
            switch (selected.Id)
            {
                ...
                case "mage":
                    ...
                    build.startingMageWeapon = MageLoadout.ValidWeapon(mageWeapon);
                    build.weapons.Add(new WeaponSaveData(build.startingMageWeapon, 2)); break;
                case "lancer":
