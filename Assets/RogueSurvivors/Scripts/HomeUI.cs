    ...
    public sealed class HomeUI : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            for (int i = 0; i < CharacterCatalog.All.Length; i++)
            {
                ...
                label.fontSize = 15;
                var portrait = UIFactory.Panel("立ち絵", cards[i].transform, new Vector2(.5f, .5f), new Vector2(0, 72), new Vector2(76, 76), Color.white);
                portrait.sprite = Resources.Load<Sprite>("RogueSurvivors/Art/" + character.Id);
